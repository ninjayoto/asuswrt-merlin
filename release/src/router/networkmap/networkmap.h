...
typedef struct
{
  ...
  unsigned char device_name1[32];
  unsigned char name_flags1[2];
  unsigned char device_name2[32];
  unsigned char name_flags2[2];
  unsigned char device_name3[32];
  unsigned char name_flags3[2];
  unsigned char device_name4[32];
  unsigned char name_flags4[2];
  unsigned char device_name5[32];
  unsigned char name_flags5[2];
  unsigned char device_name6[32];
