								...
								<tr bgcolor="#4D595D">
									<td valign="top">
										...
										<div style="margin-top:8px">   
											<textarea cols="63" rows="25" readonly="readonly" wrap="off" style="width:99%;font-family:'Courier New', Courier, mono; font-size:13px;background:#475A5F;color:#FFFFFF; overflow-x:auto;"><% nvram_dump("ipv6_network.log", "ipv6_network.sh"); %></textarea>
										</div>
										<div class="apply_gen">
