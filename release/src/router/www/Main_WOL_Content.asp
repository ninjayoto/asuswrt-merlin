...
function updateOptions(){
	document.form.SystemCmd.value = "ether-wake -b -i br0 " + document.form.destIP.value;
...
function showLANIPList(){
	...
	for(var i = 1; i < client_list_row.length; i++){
		...
		if(client_list_col[1])
			...
			code += '<a><div onmouseover="over_var=1;" onmouseout="over_var=0;" onclick="setClientIP(\''+macname+'\', \''+client_list_col[3]+'\');"><strong>'+client_list_col[3]+'</strong> ';
		}	
							...
							<tr>
								<td bgcolor="#4D595D" colspan="3" valign="top">
									...
									<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" class="FormTable_table" style="margin-top:8px;">
				            			...
				            			<td width="40%">
									<input type="text" class="input_20_table" maxlength="15" name="wollist_deviceName" onClick="hideClients_Block();" onkeypress="return is_alphanum(this,event);" onblur="is_safename(this);">
