...
<!--										<textarea  cols="63" rows="30" style="width:99%;font-family:'Courier New', Courier, mono; font-size:13px; background:#475A5F;color:#FFFFFF" readonly="readonly" wrap=VIRTUAL><% nvram_dump("wlan11b_2g.log","wlan11b.sh"); %></textarea> -->
									...
									<div id="wltext" style="width:752px; height:445px; border:2px solid gray; border-bottom-color:white; font-family:'Courier New', Courier, mono; font-size:13px; line-height:110%; overflow-x:auto; overflow-y:scroll;">WLSTATUS</div>
									</div>
									<div class="apply_gen">
